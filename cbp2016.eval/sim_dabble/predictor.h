...
#ifdef REALISTIC
int m[NHIST+1]={0,23,47,71,97}; // history lengths
int TB[NHIST + 1]  ={0,14, 14, 14,14};		// tag width for the different tagged tables
int logg[NHIST + 1]={0,9,10,10,9};		// log of number entries of the different tagged tables
#else
